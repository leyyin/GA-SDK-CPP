...
#if USE_UWP
        const std::string GADevice::_sdkWrapperVersion = "uwp_cpp 2.0.0";
#elif USE_TIZEN
        const std::string GADevice::_sdkWrapperVersion = "tizen 2.0.0";
#else
        const std::string GADevice::_sdkWrapperVersion = "cpp 2.0.0";
#endif
